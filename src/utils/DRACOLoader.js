...
import decoder from './draco_decoder.wasm'
import wrapper_ from './draco_wasm_wrapper.js'
...
THREE.DRACOLoader.prototype = Object.assign(Object.create(THREE.Loader.prototype), {
    ...
    _initDecoder: function () {
        ...
        if (useJS) {
            ...
            librariesPending.push(this._loadLibrary(wrapper_, 'text'));
            librariesPending.push(this._loadLibrary(decoder, 'arraybuffer'));
